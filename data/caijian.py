...
path = r'D:\\Python\\Vehicle identification\\CCPD2020\\ccpd_green\\val'  # 改成自己的车牌路径
...
for filename in os.listdir(path):
    ...
    cv2.imencode('.jpg', img)[1].tofile(r"D:\\Python\\Vehicle identification\\CCPD2020\\ccpd_green\\ccpd_val\\{}.jpg".format(result))
    # 图片中文名会报错
