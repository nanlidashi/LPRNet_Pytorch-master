...
path = r'D:\\Python\\LPRNet_Pytorch-master\workspace\\ccpd_base'  
...
for filename in os.listdir(path):
    ...
    cv2.imencode('.jpg', img)[1].tofile(r"D:\\Python\\LPRNet_Pytorch-master\workspace\\base\\{}.jpg".format(result))
